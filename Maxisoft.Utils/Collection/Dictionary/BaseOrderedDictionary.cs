...
namespace Maxisoft.Utils.Collection.Dictionary
{
        ...
        where TList : class, IList<TKey>, new() where TDictionary : class, IDictionary<TKey, TValue>, new()
    {
        ...
        public bool Contains<TEqualityComparer>(in KeyValuePair<TKey, TValue> item, TEqualityComparer comparer) where TEqualityComparer: IEqualityComparer<TValue> 
        {
        ...
        public int IndexOf<TEqualityComparer>(in TValue value, TEqualityComparer comparer) where TEqualityComparer : IEqualityComparer<TValue>
        {
            using var _ = Version.CreateGuard();
            var c = 0;
